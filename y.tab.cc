...
{
       0,    52,    52,    56,    57,    60,    64,    67,    68,    72,
      79,    80,    84,    90,    97,    98,   102,   108,   111,   115,
     119,   122,   130,   131,   135,   138
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LESS", "AND", "PIPE", "GREATGREAT", "GREATAND", "GREATGREATAND",
  "TWOGREAT", "$accept", "goal", "commands", "command", "simple_command",
  "command_and_args", "argument_list", "argument", "command_word",
  "pipe_list", "iomodifier_opt", "iomodifier_list", "background_opt", YY_NULLPTR
};
#endif
